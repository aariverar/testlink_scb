...
<div style="float:left; height: 100%; width: 140px; text-align: center; display: flex; align-items: center; justify-content: center; padding: 5px;">
  <a href="index.php" target="_parent">
  <img alt="Company logo" title="logo" src="{$smarty.const.TL_THEME_IMG_DIR}{$tlCfg->logo_navbar}" style="display: block; margin: 0 auto; max-width: 120px; max-height: 30px; object-fit: contain;" /></a>
</div>
